...
func _build_tutorial_panel(parent: Control) -> void:
	...
	page_box.add_child(tutorial_title_label)
	...
	page_box.add_child(tutorial_step_label)
	...
	page_box.add_child(tutorial_progress_label)
	...
	tutorial_phase_label.add_theme_font_size_override("font_size", 19)
	tutorial_phase_label.add_theme_color_override("font_color", Color("#B8C4D8"))
	content_box.add_child(tutorial_phase_label)
...
func _build_radio_station_panel(parent: Control) -> void:
	...
	sub.text = "Station screen · now playing · playlist pool · menu music"
	...
	unlock_note.text = "🟢 On-Air = in Radio rotation  ·  🔴 Off-Air = excluded from Radio  ·  🟣 = Main Menu music"
...
func _update_radio_settings_ui() -> void:
	...
	for menu_id in radio_station_menu_buttons.keys():
		...
		menu_button.tooltip_text = "Clear Main Menu music override." if is_menu_music else "Set this song as Main Menu music."
...
func _build_main_menu_panel(parent: Control) -> void:
	...
	jewel_title_row.add_theme_constant_override("separation", 3)
	box.add_child(jewel_title_row)

	var jewel_letter_specs: Array = [
		{"path": "res://assets/ui/branding/wordmark_letters/sigma_s.png", "size": Vector2(49, 62)},
		{"path": "res://assets/ui/branding/wordmark_letters/sigma_i.png", "size": Vector2(40, 62)},
		{"path": "res://assets/ui/branding/wordmark_letters/sigma_g.png", "size": Vector2(62, 62)},
		{"path": "res://assets/ui/branding/wordmark_letters/sigma_m.png", "size": Vector2(76, 62)},
		{"path": "res://assets/ui/branding/wordmark_letters/sigma_a.png", "size": Vector2(56, 62)}
	]
...
func _rebuild_tournament_builder_panel() -> void:
	...
	for mode_value in _tournament_match_mode_options():
		...
		mode_button.tooltip_text = String(mode_item.get("tip", ""))
...
func _build_collections_panel(_parent: Control) -> void:
	...
	var subtitle: Label = Label.new()
	subtitle.text = "Your premium collector booklet. Equip pieces, choose boards, and preview your active set."
	subtitle.horizontal_alignment = HORIZONTAL_ALIGNMENT_CENTER
	subtitle.autowrap_mode = TextServer.AUTOWRAP_WORD_SMART
	...
	_add_collection_category_label(scroll_box, "Piece Sets")
	...
	_add_collection_category_label(scroll_box, "Board Sets")
	...
	future_note.text = "Tap a booklet card to inspect the collection. Equip a full set for matching pieces + board, or mix pieces and boards your way."
...
func _add_collections_equipped_showcase(parent: Container) -> void:
	...
	collections_equipped_pieces_label.add_theme_color_override("font_color", Color("#F7F3E8"))
	...
	collections_equipped_board_label.add_theme_color_override("font_color", Color("#F7F3E8"))
	...
	var board_button: Button = _add_button(action_row, "Inspect Board", "Open the currently equipped board set.", _open_active_board_detail)
...
func _update_collections_panel() -> void:
	...
	if collections_active_label != null:
		collections_active_label.text = "Equipped: %s\n%s · %s" % [active_set_name, active_pieces_name, active_board_name]
	...
	if collections_equipped_full_set_label != null:
		collections_equipped_full_set_label.text = "Full Set: %s" % active_set_name
	...
	if collections_equipped_note_label != null:
		collections_equipped_note_label.text = "Live preview shows your equipped collection. Cards below are your collector booklet: inspect, equip, and build your SIGMA identity."
...
func _build_rules_guide_panel(parent: Control) -> void:
	...
	rules_guide_title_label.add_theme_font_size_override("font_size", 34)
	rules_guide_title_label.add_theme_color_override("font_color", Color("#F2C14E"))
	page_box.add_child(rules_guide_title_label)
	...
	rules_guide_step_label.add_theme_font_size_override("font_size", 19)
	rules_guide_step_label.add_theme_color_override("font_color", Color("#B8C4D8"))
	page_box.add_child(rules_guide_step_label)
	...
	rules_guide_visual_caption_label = Label.new()
	rules_guide_visual_caption_label.name = "RulesGuideVisualCaptionLabel"
	rules_guide_visual_caption_label.horizontal_alignment = HORIZONTAL_ALIGNMENT_CENTER
	rules_guide_visual_caption_label.autowrap_mode = TextServer.AUTOWRAP_WORD_SMART
	rules_guide_visual_caption_label.add_theme_font_size_override("font_size", 19)
	rules_guide_visual_caption_label.add_theme_color_override("font_color", Color("#00D1FF"))
	rules_guide_visual_caption_label.visible = false
	content_box.add_child(rules_guide_visual_caption_label)
...
func _update_rules_guide_panel() -> void:
	...
	if rules_guide_visual_caption_label != null:
		...
		rules_guide_visual_caption_label.visible = caption != ""
