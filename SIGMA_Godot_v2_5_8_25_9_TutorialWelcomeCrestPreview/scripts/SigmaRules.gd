...
func load_scenario(scenario_id: String) -> void:
	...
	match scenario_id:
		...
		"tutorial_move_sentinel":
			actual_id = "tutorial_sentinel_move"
		"tutorial_move_infiltrator":
			actual_id = "tutorial_infiltrator_move"
		"tutorial_move_assassin":
			actual_id = "tutorial_assassin_move"
		"tutorial_move_monarch":
			actual_id = "tutorial_monarch_move"
	...
	match actual_id:
		...
		"tutorial_sentinel_move":
			_put_basic_monarchs()
			_place_piece(OWNER_P1, KIND_SENTINEL, 4, 4)
			reserves = [0, 0]
			turn = OWNER_P1
			scenario_hint = "Tutorial: move Gold Sentinel from r5 c5 to r6 c6. Sentinels move 1 space in any direction."

		"tutorial_infiltrator_move":
			_put_basic_monarchs()
			_place_piece(OWNER_P1, KIND_INFILTRATOR, 4, 4)
			reserves = [0, 0]
			turn = OWNER_P1
			scenario_hint = "Tutorial: move Gold Infiltrator from r5 c5 to r5 c7. Infiltrators move 1 or 2 spaces orthogonally through clear spaces."

		"tutorial_assassin_move":
			_put_basic_monarchs()
			_place_piece(OWNER_P1, KIND_ASSASSIN, 4, 4)
			reserves = [0, 0]
			turn = OWNER_P1
			scenario_hint = "Tutorial: move Gold Assassin from r5 c5 to r3 c7. Assassins move 1 or 2 spaces diagonally through clear spaces."

		"tutorial_monarch_move":
			_place_piece(OWNER_P2, KIND_MONARCH, 0, 4)
			_place_piece(OWNER_P1, KIND_MONARCH, 4, 4)
			reserves = [0, 0]
			turn = OWNER_P1
			scenario_hint = "Tutorial: move the center Gold Monarch from r5 c5 to r6 c6. Monarchs move 1 space in any direction and must stay safe."
